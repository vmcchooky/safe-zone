...
Roadmap decisions should follow [Safe_Zone_OPEX_Estimate.md](deployment/Safe_Zone_OPEX_Estimate.md) as the source of truth for cost and deployment targets.
