...
func NewServiceFromEnvForRoleE(nodeRole string) (*Service, error) {
	...
	return NewService(Options{
		...
		AdblockExceptionsFile:     config.String("SAFE_ZONE_ADBLOCK_EXCEPTIONS_FILE", ""),
		AdblockShadowExactEnabled: config.Bool("SAFE_ZONE_ADBLOCK_SHADOW_EXACT_ENABLED", false),
		...
		PolicySemantics:           NormalizePolicySemantics(config.String("SAFE_ZONE_POLICY_SEMANTICS", string(PolicySemanticsSeparated))),
	}), nil
}
